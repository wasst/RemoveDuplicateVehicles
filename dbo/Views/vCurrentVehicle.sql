...
SELECT     TOP (100) PERCENT dbo.tblVehicle.VehicleID, dbo.tblVehicle.ParkingSpace, dbo.tblVehicle.Registration, dbo.tblVehicle.vehicle_model_id, 
                      ...
                      dbo.tblVehicleModel.vehicle_model_name, dbo.tblVehicleMake.vehicle_make_name, dbo.tblVehicleType.Description, ISNULL(dbo.tblPerson.FullName_Forward, 'Pool')
                       AS AssignedToPerson, dbo.tblKeyLocation.Description AS LocationDescription, dbo.tblKeyLocation.Directions AS LocationDirections, 
                      dbo.tblOrgUnit.Unit_Name AS OrgUnitName
