...
CREATE procedure [dbo].[spRecurringBooking]
as
...
set @StartDate = '1-Mar-2017'
Set @EndDate = '31-Dec-2017'
...
BEGIN
	...
	BEGIN
		...
		set @BookingEndTime = @DateLoop + @BookingEnd
			...
			SET @SQLText = @SQLText + ' SET @Destination = ''Vehicle 4422 not avail on Wednesday.  Working at Clearys Gates. ''';
